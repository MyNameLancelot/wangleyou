...
| 日期 | 变更 | 范围 |
| --- | --- | --- |
| 2026-09-21 | [照片目录布局](2026-09-21-photo-library-layout/spec.md) | 构建期相册目录发现、照片元信息、`topNN` 排序与显式首页主回忆 |
| 2026-09-21 | [首页第二屏改造](2026-09-21-home-memory-redesign/spec.md) | 首页主回忆的展示与播放、照片手势、音乐音量、主题私有媒体和两屏交界过渡 |
| 2026-09-20 | [首页审查回归修复](2026-09-20-review-regressions/change.json) | 存储访问降级、StrictMode 音频恢复、独立悬停与焦点暂停、两屏音乐滚轮及跳转链接 |
...
| 2026-09-20 | [恢复主题切换按钮](2026-09-20-restore-theme-switch/change.json) | 在保留背景音乐控制的同时恢复两套主题右下角毛玻璃主题切换入口 |
| 2026-09-20 | [音乐按钮位置与状态视觉](2026-09-20-music-toggle-placement-state/spec.md) | 音乐按钮移至主题按钮正上方，播放显示波纹，暂停显示降强调的斜杠音符 |
| 2026-09-20 | [音乐按钮右上角位置纠正](2026-09-20-music-toggle-top-right-correction/spec.md) | 纠正前次误解：音乐按钮放到屏幕右上角，并与主题按钮的收起尺寸和右侧中心线对齐 |
| 2026-09-20 | [音乐按钮仅保留悬浮放大](2026-09-20-music-toggle-hover-only/spec.md) | 取消播放波纹，hover/focus 时仅将普通或斜杠音符组合轻微放大 |
| 2026-09-20 | [音乐与主题按钮随页面滚动](2026-09-20-page-bound-theme-music-controls/spec.md) | 首页控件随第一屏离开，其他页面主题按钮随页面顶部滚动，音乐状态保持不变 |
| 2026-09-20 | [首页两屏音乐按钮](2026-09-20-home-two-screen-music-controls/spec.md) | 两段整屏各有随屏音乐入口并共享单一 audio，主题按钮只在第一屏 |
